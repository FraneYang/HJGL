<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProgressBarUpdateIn.aspx.cs" Inherits="Web.DataIn.ProgressBarUpdateIn" %>
...
<body>
    ...
    <div id="div1" runat="server" style="height: 20px;">
     <input id="hdShowItems" type="hidden" runat="server" />
