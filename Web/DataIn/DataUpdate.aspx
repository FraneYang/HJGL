<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataUpdate.aspx.cs" Inherits="Web.DataIn.DataUpdate" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function ShowProgressBarAudit(fileName, workAreaId) {
            var result = window.showModalDialog("ProgressBarUpdate.aspx?fileName=" + fileName + "&workAreaId=" + workAreaId, "", "status=no;dialogWidth=520px;dialogHeight=150px;menu=no;resizeable=no;scroll=yes;scrollbars=yes;center=yes;edge=raise;location=no");
        ...
        function ShowProgressBarInsert(fileName, workAreaId) {
            var result = window.showModalDialog("ProgressBarUpdateIn.aspx?fileName=" + fileName + "&workAreaId=" + workAreaId, "", "status=no;dialogWidth=520px;dialogHeight=150px;menu=no;resizeable=no;scroll=yes;scrollbars=yes;center=yes;edge=raise;location=no");
            if (result != null && result != "") {
        ...
        function ShowProgressBarSave(workAreaId) {
            var result = window.showModalDialog("ProgressBarUpdateSave.aspx?workAreaId=" + workAreaId, "", "status=no;dialogWidth=520px;dialogHeight=150px;menu=no;resizeable=no;scroll=yes;scrollbars=yes;center=yes;edge=raise;location=no");
            //            if (result != null && result != "") {
            //                document.getElementById("imgBtnInsert").click();
            //            }
        }
    ...
    <table id="Table5" style="width: 100%; font-size: 15px; color: Blue;" runat="server"
        ...
        <tr style="height: 28px">          
            <td style="text-align: left;">
               &nbsp;&nbsp; <asp:LinkButton ID="lkAchievements" runat="server" a
