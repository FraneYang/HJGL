...
{
    public partial class ProgressBarUpdate : PPage
    {
        /// <summary>
        /// 上传预设的虚拟路径
        /// </summary>
        ...
        private void beginProgress()
        {
            ...
            string templateFileName = Path.Combine(Server.MapPath("."), "ProgressBarUpdate.aspx");
                ...
                for (int i = 0; i < ir; i++)
                {
                    ...
                    //{
                        ...
                        if (!string.IsNullOrEmpty(row0))
                        {
                            ...
                            {
                                result += (i + 2).ToString() + "," + "单位代码" + "," + "[" + row0 + "]错误！" + "|";
                            }
                        }
                        else
                        {
