<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestPackageManageView.aspx.cs" Inherits="Web.TestPackageManage.TestPackageManageView" %>
                ...
                <table id="tabbtn" runat="server" width="100%" style="background: url('../Images/bg-1.gif')"
                    ...
                    <tr>
                        ...
                        <td align="right" valign="middle" style="width: 75%; height: 30px;"> 
                             <asp:ImageButton ID="btnAudit" runat="server" ImageUrl="~/Images/Audit.gif"  ValidationGroup="Save"
                                        ...
                                        <table id="Table5" runat="server" width="100%" cellpadding="1" cellspacing="1" class="table">
                                            ...
                                            <tr>
                                              ...
                                              <td align="right" height="25px">
                                                ...
                                                <td  align="left" height="25px">
                                                    &nbsp;<asp:TextBox ID="txtPTP_AduditDate" runat="server" CssClass="textboxStyle" Width="80%"></asp:TextBox>   
                                            ...
                                            <tr>
                                                 <td align="right" height="25px">
                                                    <asp:Label ID="Label3" runat="server" Text="完工人"></asp:Label>
                                                </td>
                                                <td  align="left" height="25px">
                                                    &nbsp;<asp:DropDownList ID="drpPTP_Finisher" runat="server" Width="80%" Height="22px">
                                                    </asp:DropDownList>
                                                    <asp:CustomValidator ID="CustomValidator5" runat="server" Display="Dynamic" ErrorMessage="请选择完工人！"
                                                        ForeColor="Red" ValidationGroup="Save" ControlToValidate="drpPTP_Finisher" ClientValidationFunction="CheckDropDownList">*</asp:CustomValidator>
                                                </td>
                                                 <td align="right" height="25px">
                                             ...
                                             <tr>
                                                 <td align="right" height="25px">
                                                    <asp:Label ID="Label19" runat="server" Text="完工时间"></asp:Label>
                                                </td>
                                                <td  align="left" height="25px">
                                                    &nbsp;<input id="txtPTP_FinishDate" runat="server" readonly="readonly" class="Wdate" style="width: 75%;
                                                        cursor: hand" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',skin:'whyGreen'})" />
                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPTP_FinishDate"
                                                        Display="Dynamic" ErrorMessage="请输入完工日期" ForeColor="Red" SetFocusOnError="True"
                                            ...
                                            <tr>
                                                ...
                                                <td  align="left" height="25px" colspan="5">
                                                   &nbsp;<asp:TextBox ID="txtPTP_Remark" runat="server" Width="95%" CssClass="textboxStyle"></asp:TextBox>                                               
                                                </td>
                                            </tr>

                                             <tr>
                                                 <td align="right" height="25px">
                                                    <asp:Label ID="Label40" runat="server" Text="完工描述"></asp:Label>
                                                </td>
                                                <td  align="left" height="25px" colspan="5">
                                                   &nbsp;<asp:TextBox ID="txtFinishDef" runat="server" Width="95%" CssClass="textboxStyle"></asp:TextBox>                                               
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
