...
{
    public partial class IsoCompreInfo :PPage
    { 
        /// <summary>
        /// 按钮权限列表
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack && this.CurrUser != null)
            {
                ...
                ButtonList = BLL.ButtonPowerService.GetButtonPowerList(roleId, BLL.Const.IsoCompreInfoMenuId);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void gvIsoCompreInfo_DataBound(object sender, EventArgs e)
        {
            if (this.gvIsoCompreInfo.BottomPagerRow == null)
            {
                return;
            }

            ((Web.Controls.GridNavgator)this.gvIsoCompreInfo.BottomPagerRow.FindControl("GridNavgator1")).GridView = this.gvIsoCompreInfo;
        }
        ...
        protected void btnFind_Click(object sender, ImageClickEventArgs e)
        {
            ...
            this.Flag = "1";
            this.gvIsoCompreInfo.PageIndex = 0;
            this.gvIsoCompreInfo.DataBind();
        }
        ...
        {
            this.gvIsoCompreInfo.BottomPagerRow.Visible = false;//导出到Excel表后，隐藏分页部分
            ...
            Response.AppendHeader("Content-Disposition", "attachment;filename=" + System.Web.HttpUtility.UrlEncode("管线综合信息表" + filename, System.Text.Encoding.UTF8) + ".xls");
            Response.ContentType = "application/ms-excel";
            this.EnableViewState = false;
            System.IO.StringWriter oStringWriter = new System.IO.StringWriter();
            System.Web.UI.HtmlTextWriter oHtmlTextWriter = new System.Web.UI.HtmlTextWriter(oStringWriter);
            this.gvIsoCompreInfo.RenderControl(oHtmlTextWriter);
