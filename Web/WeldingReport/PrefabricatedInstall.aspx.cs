...
{
    public partial class PrefabricatedInstall : PPage
    {
        /// <summary>
        /// 按钮权限列表
        /// </summary>
       ...
       /// <param name="e"></param>
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack && this.CurrUser != null)
            {
                ...
                ButtonList = BLL.ButtonPowerService.GetButtonPowerList(roleId, BLL.Const.PreInstallMenuId);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void gvPreInstall_DataBound(object sender, EventArgs e)
        {
            if (this.gvPreInstall.BottomPagerRow==null)
            {
                return;
            }
            ((Web.Controls.GridNavgator)this.gvPreInstall.BottomPagerRow.FindControl("GridNavgator1")).GridView = this.gvPreInstall;
        }
        /// <summary>
        /// 绑定参数
        /// </summary>
        ...
        protected void btnFind_Click(object sender, ImageClickEventArgs e)
        {
            ...
            this.Flag = "1";
            this.gvPreInstall.PageIndex = 0;
            this.gvPreInstall.DataBind();
        }
        ...
        {
            this.gvPreInstall.PageSize = 10000;
            this.gvPreInstall.PageIndex = 0;
            this.gvPreInstall.DataBind();
            this.gvPreInstall.BottomPagerRow.Visible = false;//导出到Excel表后，隐藏分页部分
            ...
            Response.AppendHeader("Content-Disposition", "attachment;filename=" + System.Web.HttpUtility.UrlEncode("预制安装进度表" + filename, System.Text.Encoding.UTF8) + ".xls");
            Response.ContentType = "application/ms-excel";
            this.EnableViewState = false;
            System.IO.StringWriter oStringWriter = new System.IO.StringWriter();
            System.Web.UI.HtmlTextWriter oHtmlTextWriter = new System.Web.UI.HtmlTextWriter(oStringWriter);
            this.gvPreInstall.RenderControl(oHtmlTextWriter);
