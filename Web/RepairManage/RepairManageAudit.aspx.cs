...
{
    public partial class RepairManageAudit : PPage
    {
        #region 定义项
        /// <summary>
        /// 委托主键
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack && this.CurrUser != null)
            {
                ...
                this.ButtonList = BLL.ButtonPowerService.GetButtonPowerList(roleId, BLL.Const.RepairManageAuditMenuId);
        ...
        /// 重新绑定gv
        /// </summary>
        protected void GetResetgvDataBind()
        {
            trustItems.Clear();
