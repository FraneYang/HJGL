<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairManageEdit.aspx.cs" Inherits="Web.RepairManage.RepairManageEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function ShowSearch(unitId, installationId, CH_TrustID) {
            var result = window.showModalDialog("ShowRepairSearch.aspx?rnd=" + (new Date()).getTime() + "&unitId=" + unitId + "&installationId=" + installationId + "&CH_TrustID=" + CH_TrustID, "", "status=no;dialogWidth=750px;dialogHeight=478px;menu=no;resizeable=no;scroll=no;center=yes;edge=raise;location=no");
                                    ...
                                    <td colspan="3" id="AddItem" runat="server">
                                        <table id="Table5" runat="server" width="100%" cellpadding="1" cellspacing="1" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" align="left" height="25px">
                                                    &nbsp;<asp:DropDownList 
                                                        ID="drpCH_AcceptGrade" runat="server" Width="80%" 
                                                      Height="22px"  CssClass="textboxStyle"  AutoPostBack="true"
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" align="left" height="25px">
                                                    &nbsp;<asp:DropDownList ID="drpCH_SlopeType" runat="server" Width="80%" 
                                                       Height="22px" CssClass="textboxStyle"></asp:DropDownList>
                                                </td>
                                                <td width="10%" align="right" height="25px">
                                            ...
                                            <tr>
                                                <td width="10%" align="right" height="25px">
                                                    <asp:Label ID="Label23" runat="server" Text="需检日期" Font-Bold="true"></asp:Label>
                                                </td>
                                                <td width="20%" align="left" height="25px">
                                                ...
                                                <td width="80%" align="left" height="25px" colspan="3">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="焊接方法" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                                 ...
                                                 <asp:TemplateField HeaderText="是否切除">
                                                    <ItemTemplate>
                                                        <asp:CheckBox id="rblPointType" runat="server" ToolTip="选择是否切除口"/>
