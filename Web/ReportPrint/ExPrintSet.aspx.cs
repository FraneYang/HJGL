...
{
    public partial class ExPrintSet : PPage
    {
        /// <summary>
        /// 部门报表Id
        /// </summary>
        ...
        {
            string str = "UPDATE dbo.ReportServer SET TabContent = InitTabContent WHERE ReportId = '" + reportId + "' and ProjectId='" + this.CurrUser.ProjectId + "'";
            try
            {
