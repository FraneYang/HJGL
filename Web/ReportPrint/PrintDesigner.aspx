<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintDesigner.aspx.cs" Inherits="Web.ReportPrint.PrintDesigner" %>
        ...
        <table id="Table1" runat="server"  width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td align="left" style="height: 32px" width="45%">
                <asp:Button ID="BtnReportDesigner" runat="server" Text="报表设计" 
                    onclick="BtnReportDesigner_Click"  ValidationGroup="Save"/>&nbsp;&nbsp;
            </td>
          </tr>
        </table>  
