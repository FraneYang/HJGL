<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ElectrodeRecovery.aspx.cs"
    Inherits="Web.MaterialManage.ElectrodeRecovery" %>

<%@ Register Src="~/Controls/GridNavgator.ascx" TagName="GridNavgator" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>焊条发放回收记录</title>
...
<body>
                    ...
                    <table id="TableS" runat="server" width="100%" cellpadding="1" cellspacing="1" class="table">
                        <tr style="height: 32px">
                            ...
                            &nbsp;<input id="txtEndDate" runat="server" readonly="readonly" class="Wdate" style="width: 40%;
                                cursor: hand" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',skin:'whyGreen'})" /></td>
    ...
    <div id="div1" runat="server" style="overflow: auto;">
        <table id="Table8" width="100%" cellpadding="0" cellspacing="0" runat="server">
            <tr>
                <td style="width: 100%">
                    <asp:GridView ID="gvElectrodeRecovery" runat="server" AllowPaging="True" AllowSorting="True"
                        PageSize="12" DataSourceID="ObjectDataSource1" AutoGenerateColumns="False" HorizontalAlign="Justify"
                        Width="100%" OnDataBound="gvElectrodeRecovery_DataBound" OnRowCommand="gvElectrodeRecovery_RowCommand">
                        <AlternatingRowStyle CssClass="GridBgColr" />
                        <Columns>
                            <asp:TemplateField HeaderText="编号">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnElectrodeCode" runat="server" CommandArgument='<%# Bind("ElectrodeRecoveryId") %>'
                                        CommandName="click" CssClass="ItemLink" Text='<%# Bind("ElectrodeRecoveryCode") %>'
                                        ToolTip="修改"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle Width="20%" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="ProjectId" HeaderText="工程名称">
                                <ItemStyle Width="20%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ElectrodeRecoveryDate" DataFormatString="{0:d}" HeaderText="发放回收日期">
                                <ItemStyle Width="20%" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="删除">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgbtnDelete" runat="server" CommandName="del" ToolTip="删除"
                                        ImageUrl="~/Images/DeleteBtn.gif" CommandArgument='<%# Bind("ElectrodeRecoveryId") %>'
                    ...
                    <asp:ObjectDataSource runat="server" ID="ObjectDataSource1" TypeName="BLL.ElectrodeRecoveryService"
