<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowTrustSearch.aspx.cs"
    Inherits="Web.TrustManage.ShowTrustSearch" %>
        ...
        <tr>
            ...
            <div id="gridviewDiv" style=" height:393px; width:100%;overflow:auto" >
                <asp:GridView ID="gvPW_JointInfo" runat="server"   AllowPaging="True" AllowSorting="True"
                                ...
                                AutoGenerateColumns="False" HorizontalAlign="Justify" PageSize="20"
                                OnPageIndexChanging="gvPW_JointInfo_PageIndexChanging"
                       ...
                       SelectMethod="getListData" SelectCountMethod="getListCount" TypeName="BLL.ShowTrustSearchService" 
