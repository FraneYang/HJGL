<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrustManageAudit.aspx.cs" Inherits="Web.TrustManage.TrustManageAudit" %>
                                    ...
                                    <td colspan="3" id="AddItem" runat="server">
                                        <table id="Table5" runat="server" width="100%" cellpadding="1" cellspacing="1" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" align="left" height="25px">
                                                    &nbsp;<asp:DropDownList ID="drpCH_AcceptGrade" runat="server" Width="80%" ></asp:DropDownList></td>
                                                <td width="10%" align="right" height="25px">
                                                    <asp:Label ID="Label20" runat="server" Text="介质温度"></asp:Label>
                                                </td>
                                                <td width="20%" align="left" height="25px">
                                                    &nbsp;<asp:TextBox ID="txtCH_ServiceTemp" runat="server" Width="80%" CssClass="textboxStyle" ></asp:TextBox>
                                                </td>
                                                <td width="10%" align="right" height="25px">
