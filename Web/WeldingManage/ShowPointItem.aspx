<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowPointItem.aspx.cs" Inherits="Web.WeldingManage.ShowPointItem" %>
                                ...
                                <asp:GridView ID="gvTrustItem" runat="server" AllowSorting="True" PageSize="500"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="焊接区域">
                                                    <ItemTemplate>
                                                        <asp:Label ID="WLO_Code" runat="server" Text='<%# Bind("WorkAreaCode") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="20%" />
                                                </asp:TemplateField>
