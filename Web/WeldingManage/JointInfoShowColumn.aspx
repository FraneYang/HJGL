<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JointInfoShowColumn.aspx.cs"
    Inherits="Web.WeldingManage.JointInfoShowColumn" %>
                ...
                <table id="tabbtn" runat="server" width="100%" style="background: url('../Images/bg-1.gif')"
                    ...
                    <tr>
                        ...
                        <td align="right" valign="middle" style="width: 55%; height: 30px;">
                            ...
                            <asp:ImageButton ID="btnSave" runat="server" ImageUrl="~/Images/Select.jpg" 
                                EnableTheming="True" onclick="btnSave_Click" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td width="100%" align="left">
                <div id="div1" style="width: 100%; height: 250px; overflow: auto;" runat="server">
                    <asp:CheckBoxList ID="chblColumn" runat="server" Width="95%" CellSpacing="3" DataTextField="Text"
