<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pressure.aspx.cs" Inherits="Web.BaseInfo.Pressure" %>
...
<body>
    ...
    <div>
        <table id="Table1" runat="server" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td align="right" width="20%" class="style1" height="32px">
                                &nbsp;
                                <asp:Label ID="Label1" runat="server" Text="试压代号"></asp:Label>
                            </td>
                            <td width="30%" align="left" class="style1">
                                &nbsp;
                                <asp:TextBox ID="txtTPTCode" runat="server" CssClass="textboxStyle" Width="80%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTPTCode"
                                    Display="Dynamic" ErrorMessage="&quot;请输入试压代号！&quot;" ForeColor="Red" SetFocusOnError="True"
                                    ValidationGroup="Save">*</asp:RequiredFieldValidator>
                            </td>
                            <td width="20%" align="right" class="style1">
                                <asp:Label ID="Label2" runat="server" Text="试压名称"></asp:Label>
                            </td>
                            <td align="left" class="style1" width="30%">
                                &nbsp;
                                <asp:TextBox ID="txtTPTName" runat="server" CssClass="textboxStyle" Width="80%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTPTName"
                                    Display="Dynamic" ErrorMessage="&quot;请输入试压名称！&quot;" ForeColor="Red" SetFocusOnError="True"
                                    ValidationGroup="Save">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td>
                    <asp:GridView ID="gvPackageTestType" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" HorizontalAlign="Justify"
                        PageSize="12" Width="100%" ondatabound="gvPackageTestType_DataBound" 
                        onrowcommand="gvPackageTestType_RowCommand">
                        <AlternatingRowStyle CssClass="GridBgColr" />
                        <Columns>
                            <asp:BoundField DataField="TPT_Code" HeaderText="试压代号">
                                <HeaderStyle Width="20%" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="试压名称">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbTestingId" runat="server" CommandArgument='<%# Bind("TPT_ID") %>'
                                        CssClass="ItemLink" Text='<%# Bind("TPT_TypeName") %>' CommandName="click"></asp:LinkButton>
                                </ItemTemplate>
                                <HeaderStyle Width="20%" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="TPT_Remark" HeaderText="备注">
                                <HeaderStyle Width="55%" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="删除">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton_1" runat="server" CommandArgument='<%# Bind("TPT_ID") %>'
                                        CommandName="Del" ImageUrl="~/Images/DeleteBtn.gif" OnClientClick="return confirm(&quot;确定要删除此试压类型吗？&quot;);" />
                                </ItemTemplate>
                                <HeaderStyle Width="5%" />
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" SelectCountMethod="GetListCount"
                        SelectMethod="GetListData" TypeName="BLL.PressureService" 
