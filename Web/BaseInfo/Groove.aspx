<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Groove.aspx.cs" Inherits="Web.BaseInfo.Groove" %>
...
<body>
    ...
    <div>
        <table id="Table1" runat="server" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td align="right" width="20%" class="style1" height="32px">
                                &nbsp;
                                <asp:Label ID="Label1" runat="server" Text="坡口代号"></asp:Label>
                            </td>
                            <td width="30%" align="left" class="style1">
                                &nbsp;
                                <asp:TextBox ID="txtJSTCode" runat="server" CssClass="textboxStyle" Width="80%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtJSTCode"
                                    Display="Dynamic" ErrorMessage="&quot;请输入坡口代号！&quot;" ForeColor="Red" SetFocusOnError="True"
                                    ValidationGroup="Save">*</asp:RequiredFieldValidator>
                            </td>
                            <td width="20%" align="right" class="style1">
                                <asp:Label ID="Label2" runat="server" Text="坡口名称"></asp:Label>
                            </td>
                            <td align="left" class="style1" width="30%">
                                &nbsp;
                                <asp:TextBox ID="txtJSTName" runat="server" CssClass="textboxStyle" Width="80%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtJSTName"
                                    Display="Dynamic" ErrorMessage="&quot;请输入坡口名称！&quot;" ForeColor="Red" SetFocusOnError="True"
                                    ValidationGroup="Save">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td>
                    <asp:GridView ID="gvGroove" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" HorizontalAlign="Justify"
                        PageSize="12" Width="100%" ondatabound="gvGroove_DataBound" 
                        onrowcommand="gvGroove_RowCommand">
                        <AlternatingRowStyle CssClass="GridBgColr" />
                        <Columns>
                            <asp:BoundField DataField="JST_Code" HeaderText="坡口代号">
                                <HeaderStyle Width="20%" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="坡口名称">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbTestingId" runat="server" CommandArgument='<%# Bind("JST_ID") %>'
                                        CssClass="ItemLink" Text='<%# Bind("JST_Name") %>' CommandName="click"></asp:LinkButton>
                                </ItemTemplate>
                                <HeaderStyle Width="20%" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="JST_Remark" HeaderText="备注">
                                <HeaderStyle Width="55%" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="删除">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton_1" runat="server" CommandArgument='<%# Bind("JST_ID") %>'
                                        CommandName="Del" ImageUrl="~/Images/DeleteBtn.gif" OnClientClick="return confirm(&quot;确定要删除此坡口类型吗？&quot;);" />
                                </ItemTemplate>
                                <HeaderStyle Width="5%" />
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" SelectCountMethod="GetListCount"
                        SelectMethod="GetListData" TypeName="BLL.GrooveService" 
